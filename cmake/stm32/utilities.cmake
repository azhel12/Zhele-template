...
FetchContent_Declare(
    STM32-ZHELE
    GIT_REPOSITORY https://github.com/azhel12/zhele/
    GIT_TAG        master
    GIT_PROGRESS   TRUE
)
...
function(stm32_fetch_zhele)
	if(NOT STM32_ZHELE_PATH)
        FetchContent_MakeAvailable(STM32-ZHELE)
        set(STM32_ZHELE_PATH ${stm32-zhele_SOURCE_DIR} PARENT_SCOPE)
	else()
		message(INFO "STM32_ZHELE_PATH specified, skipping fetch for STM32-ZHELE")
	endif()
endfunction()